...
/* ./src/sensors/sht3x/sht3x_pl.lang */ const char SENSOR_SHT3[] PROGMEM = "SHT3x";
 const char INTL_LCD_NONE[] PROGMEM = "Translate PL: INTL_LCD_NONE 🐱;";
 const char INTL_LCD1602[] PROGMEM = "Translate PL: INTL_LCD1602 🐱;";
 const char INTL_LCD2004[] PROGMEM = "Translate PL: INTL_LCD2004 🐱;";
