...
const char INTL_WIFI_PHY_MODE[] PROGMEM = "Tryb pracy WiFi (1=B / 2=G / 3=N)";
...
const char INTL_AB_HIER_NUR_ANDERN[] PROGMEM = "Ustawienia zaawansowane";
...
const char INTL_LCD[] PROGMEM = "Ma wyświetlacz";
...
const char INTL_MHZ14A[] PROGMEM = "Winsen MH-Z14A CO2 sensor";
const char INTL_MHZ14A_VAL[] PROGMEM = "WINSEN MH-Z14A";
