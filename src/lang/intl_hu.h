...
const char INTL_WIFI_PHY_MODE[] PROGMEM = "WiFi Phy Mode (1=B / 2=G / 3=N)";
...
const char INTL_AB_HIER_NUR_ANDERN[] PROGMEM = "Haladó beállítások";
...
const char INTL_LCD[] PROGMEM = "Has character LCD";
...
const char INTL_MHZ14A_VAL[] PROGMEM = "WINSEN";
